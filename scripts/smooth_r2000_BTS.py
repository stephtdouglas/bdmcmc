...
am = bdmcmc.get_mod.AtmoModel(modelpath+'btsettl_2013.pkl')#,wave_unit=u.um)
...
new_grid = bdmcmc.smooth.smooth_grid(am.model,new_wave,
    variable=False,res=res,incremental_outfile='BTS_r2000_backup.pkl')
...
outfile = open(modelpath+'SXD_r2000_BTS13.pkl','wb')
